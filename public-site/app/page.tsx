...
async function getUpcomingEvents() {
    try {
        ...
        return res.data.filter((event: Event) => new Date(event.eventDate) > new Date()).slice(0, 3);
    } catch (error) {
        return [];
    }
}
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <header className="bg-white shadow-sm p-4 text-center">
          <h1 className="text-4xl font-bold text-gray-800">Centre for Criminal Law Research</h1>
          <p className="text-gray-600">Exploring the frontiers of criminal jurisprudence.</p>
      </header>

      <main className="container mx-auto p-8 grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Latest Blogs Section */}
        <section className="md:col-span-2">
          <h2 className="text-2xl font-semibold border-b-2 border-gray-300 pb-2 mb-4">Latest Research & Analysis</h2>
        ...
        <aside className="space-y-8">
          ...
          <div>
            <h2 className="text-xl font-semibold border-b-2 border-gray-300 pb-2 mb-4">Upcoming Events</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold border-b-2 border-gray-300 pb-2 mb-4">Recent Publications</h2>
            <div className="space-y-4">
